...
class DBSRNetVAE(nn.Module):
    """ Deep Burst Super-Resolution model with VAE"""
...
def dbsrnet_vae(enc_init_dim, enc_num_res_blocks, enc_out_dim,
    ...
    vae = models.dbsr.vae()
    # TODO: Update
    net = DBSRNetVAE(encoder=encoder, merging=merging, decoder=vae)
    return net
